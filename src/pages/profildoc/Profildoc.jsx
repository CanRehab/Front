...
import rpicon1 from '../../rpicon1.jpeg';
import rpicon2 from '../../rpicon2.jpeg';
import './profildoc.css';
...
<Text titlep=' Innovation with impact' textp='All of our patient care, education and research are driven to make discoveries that can help heal you.'/>
    ...
    <div className='lpbox'>
        <a className='lpboxtext'> <NavLink to="/appointments">Book an appointments</NavLink></a>
    </div>
</div>
